...
use crate::content::{ContentOp, TextOp, parse_content_stream};
...
impl TextExtractor {
    ...
    pub fn extract_from_page(page: &crate::doc::Page, doc: &mut CosDoc) -> Result<String> {
        let mut result = String::new();
    ...
    fn extract_annotation_text(page: &crate::doc::Page, doc: &mut CosDoc) -> String {
...
fn resolve_resources(page: &crate::doc::Page, doc: &mut CosDoc) -> Result<PdfObject> {
