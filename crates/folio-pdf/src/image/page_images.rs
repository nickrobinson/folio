...
use super::embed::PdfImage;
use crate::core::{Rect, Result};
use crate::cos::{CosDoc, PdfObject, PdfStream};
...
pub fn add_image_to_page(
    ...
    let page = doc
        ...
        .ok_or_else(|| crate::core::FolioError::InvalidObject("Page not found".into()))?
        .clone();
...
mod tests {
    use super::*;
    use crate::image::embed::PdfImage;
