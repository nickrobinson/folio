...
use super::ops::{ContentOp, TextOp};
use crate::core::{Matrix2D, Result};
use crate::cos::PdfObject;
use crate::cos::parser::parse_object;
use crate::cos::tokenizer::{Token, Tokenizer};
...
fn is_whitespace_or_delimiter(b: u8) -> bool {
    crate::cos::tokenizer::is_whitespace(b) || crate::cos::tokenizer::is_delimiter(b)
}
